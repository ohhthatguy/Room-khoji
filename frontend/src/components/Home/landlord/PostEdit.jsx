...
const PostEdit = ({ post, edit, setEdit, darkMode }) => {
    ...
    if (productImage) {
      const sendProductImageToDB = async () => {
        ...
        try {
          ...
          setPostData({
            ...postData,
            productImages: [...response.data, ...postData.productImages],
  ...
  const handleCancel = (ele) => {
    ...
    setPostData({
      ...postData,
      productImages: [...postData.productImages.filter((e) => ele !== e)],
    });
  };
  ...
  const validateForm = () => {
    ...
    if (
      ...
      postData.Parking &&
      postData.Water &&
      postData.productImages.length > 0 &&
      (postData.Quantity > 0 ||
  ...
  return (
    <>
      ...
      >
        ...
        <Box sx={{ display: "flex", flexDirection: "column", rowGap: "2rem" }}>
          <TextField
            ...
            defaultValue={1}
            error={postData.Quantity < 1 || postData.Quantity > 10}
            helperText={
              postData.Quantity < 0
          ...
          <TextField
            label="Rate (/month)"
            defaultValue={1000}
            error={postData.Rate < 1000 || postData.Rate > 100000}
            helperText={
              postData.Rate < 1000
        ...
        <Box sx={{ color: darkMode ? "white" : "black" }}>
          ...
          <RadioGroup
            ...
            onChange={(e) =>
              setPostData({ ...postData, Water: e.target.value })
            }
          >
            <FormControlLabel
              value="24hrs"
        ...
        <Box sx={{ color: darkMode ? "white" : "black" }}>
          ...
          <RadioGroup
            ...
            onChange={(e) =>
              setPostData({ ...postData, Parking: e.target.value })
            }
          >
            <FormControlLabel
              value="spacious"
        ...
        <Box sx={{ color: darkMode ? "white" : "black" }}>
          ...
          <RadioGroup
            ...
            onChange={(e) =>
              setPostData({ ...postData, People: e.target.value })
            }
          >
            <FormControlLabel
              value="Couple"
        ...
        <Box sx={{ color: darkMode ? "white" : "black" }}>
          ...
          <RadioGroup
            row
            value={postData.Pets}
            onChange={(e) => setPostData({ ...postData, Pets: e.target.value })}
          >
            <FormControlLabel
              value="Allowed"
              name="Pets"
      ...
      '& .MuiFormHelperText-root': { color: darkMode ? 'white' : 'black' },
        ...
        >
          {postData.productImages &&
            postData.productImages.length > 0 &&
            postData.productImages.map((ele, index) => (
              <Box
                key={index}
                sx={{
                  height: "7rem",
                  ...
                  background: `url(${ele}) no-repeat 75% 25% / cover`,
                }}
              >
                <Cancel
                  sx={{
                    display:
                      postData.productImages.length <= 1 ? "none" : "block",
                  }}
