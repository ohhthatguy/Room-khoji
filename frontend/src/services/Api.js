...
const API_OBJECT = {
  ...
  getPostByCategory: {
    method: "get",
    url: "/tenant/productmarket",
    params: true,
  },
  getRecommendedList: {
    method: "get",
    url: "/tenant/recommended",
    params: true,
  },
  ...
  registerClickAPI: {
    method: "post",
    url: "/post/registerClick",
    params: true,
  },
  getLocation: { method: "post", url: "/getLocation" },
...
axiosInstance.interceptors.request.use(
  ...
  function (err) {
    //this function activates when request( from frontend) fails
...
axiosInstance.interceptors.response.use(
  function (response) {
    //this function activates when response( from backend) is successful
    return { isSuccess: true, data: response.data };
  },

  function (error) {
    //this function activates when response( from backend) fails
    // console.log(error)
    if (error.response) {
